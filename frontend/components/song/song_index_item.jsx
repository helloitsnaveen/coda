...
class SongIndexItem extends React.Component {
    ...
    playButtonClick() {
        this.props.getTrack(this.props.songId);
        // .then(res => console.log(res.song))
    };
    ...
    render() {
        return (
            <li>
                <div className='song-index-item-outer-div'>
                    <img className='song-index-OUTER-image-tag' src={this.props.song.image} />
                    ...
                    <div className='song-index-item-rest'>
                        <div className='song-index-item-title-and-duration'>
                            ...
                            <div className='song-index-item-title-container'>
                                <Link exact to={`/songs/${this.props.songId}`} className='song-index-item-title'>{this.props.song.title}</Link>
                            </div>
