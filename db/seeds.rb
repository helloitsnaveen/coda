...
# SEED SONGIMAGE LINK
declineIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/1DECLINEIMAGE.jpg')
fragilityIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/2FRAGILITYIMAGE.jpg')
speedIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/3SPEEDIMAGE.jpg')
separateIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/4SEPARATEIMAGE.jpg')
yayayaIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/5YAYAYAIMAGE.jpg')
waterBottleIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/6WATERBOTTLEIMAGE.jpg')
chipsDipIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/7CHIPSANDDIPIMAGE.jpg')
boomBapIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/8BOOMBAPIMAGE.jpg')
hardHitterIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/9HARDHITTERIMAGE.jpg')
guacIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/10GUACIMAGE.jpg')
moreGuacIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/11MOREGUACIMAGE.jpg')
extraGuacIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/12EXTRAGUACIMAGE.jpg')
onionRingsIMAGE = open('https://coda-seeds.s3-us-west-1.amazonaws.com/13ONIONRINGSIMAGE.jpg')

# SEED SONGTRACK LINK 
declineTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/1DECLINETRACK.wav')
fragilityTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/2FRAGILITYTRACK.wav')
speedTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/3SPEEDTRACK.wav')
separateTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/4SEPARATETRACK.wav')
yayayaTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/5YAYAYATRACK.wav')
waterBottleTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/6WATERBOTTLETRACK.wav')
chipsDipTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/7CHIPSANDDIPTRACK.mp3')
boomBapTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/8BOOMBAPTRACK.wav')
hardHitterTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/9HARDHITTERTRACK.wav')
guacTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/10GUACTRACK.wav')
moreGuacTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/11MOREGUACTRACK.wav')
extraGuacTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/12EXTRAGUACTRACK.wav')
onionRingsTRACK = open('https://coda-seeds.s3-us-west-1.amazonaws.com/13ONIONRINGSTRACK.wav')
